...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../top_level.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8083298
SOPC_SYSID_FLAG += --sidp=0x8083298
ELF_PATCH_FLAG  += --sidp 0x8083298

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1677100185
SOPC_SYSID_FLAG += --timestamp=1677100185
ELF_PATCH_FLAG  += --timestamp 1677100185
