...
# setting SOPC_SYSID_BASE_ADDRESS is 0x80830a0
SOPC_SYSID_FLAG += --sidp=0x80830a0
ELF_PATCH_FLAG  += --sidp 0x80830a0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1676492413
SOPC_SYSID_FLAG += --timestamp=1676492413
ELF_PATCH_FLAG  += --timestamp 1676492413
