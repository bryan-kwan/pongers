...
module top_level_mm_interconnect_0 (
		...
		input  wire [18:0] top_level_data_master_address,               //                 top_level_data_master.address
		...
		input  wire [18:0] top_level_instruction_master_address,        //          top_level_instruction_master.address
	...
	wire  [18:0] top_level_data_master_translator_avalon_universal_master_0_address;              // top_level_data_master_translator:uav_address -> top_level_data_master_agent:av_address
	...
	wire  [94:0] rsp_mux_src_data;                                                                // rsp_mux:src_data -> top_level_data_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                               // top_level_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [4:0] rsp_mux_src_channel;                                                             // rsp_mux:src_channel -> top_level_data_master_agent:rp_channel
	...
	wire  [18:0] top_level_instruction_master_translator_avalon_universal_master_0_address;       // top_level_instruction_master_translator:uav_address -> top_level_instruction_master_agent:av_address
	...
	wire  [94:0] rsp_mux_001_src_data;                                                            // rsp_mux_001:src_data -> top_level_instruction_master_agent:rp_data
	wire         rsp_mux_001_src_ready;                                                           // top_level_instruction_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire   [4:0] rsp_mux_001_src_channel;                                                         // rsp_mux_001:src_channel -> top_level_instruction_master_agent:rp_channel
	...
	wire  [18:0] top_level_debug_mem_slave_agent_m0_address;                                      // top_level_debug_mem_slave_agent:m0_address -> top_level_debug_mem_slave_translator:uav_address
	...
	wire  [95:0] top_level_debug_mem_slave_agent_rf_source_data;                                  // top_level_debug_mem_slave_agent:rf_source_data -> top_level_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [95:0] top_level_debug_mem_slave_agent_rsp_fifo_out_data;                               // top_level_debug_mem_slave_agent_rsp_fifo:out_data -> top_level_debug_mem_slave_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_001_src_data;                                                            // cmd_mux_001:src_data -> top_level_debug_mem_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                           // top_level_debug_mem_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [4:0] cmd_mux_001_src_channel;                                                         // cmd_mux_001:src_channel -> top_level_debug_mem_slave_agent:cp_channel
	...
	wire  [94:0] cmd_mux_003_src_data;                                                            // cmd_mux_003:src_data -> ledr_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                           // ledr_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                         // cmd_mux_003:src_channel -> ledr_s1_agent:cp_channel
	...
	wire  [94:0] top_level_data_master_agent_cp_data;                                             // top_level_data_master_agent:cp_data -> router:sink_data
	...
	wire  [94:0] top_level_instruction_master_agent_cp_data;                                      // top_level_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire         top_level_debug_mem_slave_agent_rp_valid;                                        // top_level_debug_mem_slave_agent:rp_valid -> router_003:sink_valid
	wire  [94:0] top_level_debug_mem_slave_agent_rp_data;                                         // top_level_debug_mem_slave_agent:rp_data -> router_003:sink_data
	wire         top_level_debug_mem_slave_agent_rp_ready;                                        // router_003:sink_ready -> top_level_debug_mem_slave_agent:rp_ready
	wire         top_level_debug_mem_slave_agent_rp_startofpacket;                                // top_level_debug_mem_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         top_level_debug_mem_slave_agent_rp_endofpacket;                                  // top_level_debug_mem_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [94:0] ledr_s1_agent_rp_data;                                                           // ledr_s1_agent:rp_data -> router_005:sink_data
	...
	wire         top_level_debug_mem_slave_agent_rdata_fifo_src_valid;                            // top_level_debug_mem_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] top_level_debug_mem_slave_agent_rdata_fifo_src_data;                             // top_level_debug_mem_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         top_level_debug_mem_slave_agent_rdata_fifo_src_ready;                            // avalon_st_adapter_001:in_0_ready -> top_level_debug_mem_slave_agent:rdata_fifo_src_ready
	...
	top_level_mm_interconnect_0_router_003 router_004 (
	...
	top_level_mm_interconnect_0_router_002 router_005 (
	...
	top_level_mm_interconnect_0_router_002 router_006 (
	...
	top_level_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (top_level_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	top_level_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (top_level_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	top_level_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (top_level_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	top_level_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (top_level_reset_reset_bridge_in_reset_reset), // clk_reset.reset
