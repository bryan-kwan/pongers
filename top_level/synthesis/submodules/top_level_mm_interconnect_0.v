...
module top_level_mm_interconnect_0 (
	...
	wire  [109:0] cmd_mux_013_src_data;                                                                                                    // cmd_mux_013:src_data -> spi_0_spi_control_port_agent:cp_data
	wire          cmd_mux_013_src_ready;                                                                                                   // spi_0_spi_control_port_agent:cp_ready -> cmd_mux_013:src_ready
	wire   [14:0] cmd_mux_013_src_channel;                                                                                                 // cmd_mux_013:src_channel -> spi_0_spi_control_port_agent:cp_channel
	...
	wire  [110:0] spi_1_spi_control_port_agent_rf_source_data;                                                                             // spi_1_spi_control_port_agent:rf_source_data -> spi_1_spi_control_port_agent_rsp_fifo:in_data
	...
	wire  [110:0] spi_1_spi_control_port_agent_rsp_fifo_out_data;                                                                          // spi_1_spi_control_port_agent_rsp_fifo:out_data -> spi_1_spi_control_port_agent:rf_sink_data
	...
	wire          cmd_mux_014_src_valid;                                                                                                   // cmd_mux_014:src_valid -> spi_1_spi_control_port_agent:cp_valid
	wire  [109:0] cmd_mux_014_src_data;                                                                                                    // cmd_mux_014:src_data -> spi_1_spi_control_port_agent:cp_data
	wire          cmd_mux_014_src_ready;                                                                                                   // spi_1_spi_control_port_agent:cp_ready -> cmd_mux_014:src_ready
	wire   [14:0] cmd_mux_014_src_channel;                                                                                                 // cmd_mux_014:src_channel -> spi_1_spi_control_port_agent:cp_channel
	wire          cmd_mux_014_src_startofpacket;                                                                                           // cmd_mux_014:src_startofpacket -> spi_1_spi_control_port_agent:cp_startofpacket
	wire          cmd_mux_014_src_endofpacket;                                                                                             // cmd_mux_014:src_endofpacket -> spi_1_spi_control_port_agent:cp_endofpacket
	...
	wire  [109:0] spi_0_spi_control_port_agent_rp_data;                                                                                    // spi_0_spi_control_port_agent:rp_data -> router_016:sink_data
	...
	wire          spi_1_spi_control_port_agent_rp_valid;                                                                                   // spi_1_spi_control_port_agent:rp_valid -> router_017:sink_valid
	wire  [109:0] spi_1_spi_control_port_agent_rp_data;                                                                                    // spi_1_spi_control_port_agent:rp_data -> router_017:sink_data
	wire          spi_1_spi_control_port_agent_rp_ready;                                                                                   // router_017:sink_ready -> spi_1_spi_control_port_agent:rp_ready
	wire          spi_1_spi_control_port_agent_rp_startofpacket;                                                                           // spi_1_spi_control_port_agent:rp_startofpacket -> router_017:sink_startofpacket
	wire          spi_1_spi_control_port_agent_rp_endofpacket;                                                                             // spi_1_spi_control_port_agent:rp_endofpacket -> router_017:sink_endofpacket
	...
	wire          spi_1_spi_control_port_agent_rdata_fifo_src_valid;                                                                       // spi_1_spi_control_port_agent:rdata_fifo_src_valid -> avalon_st_adapter_014:in_0_valid
	wire   [33:0] spi_1_spi_control_port_agent_rdata_fifo_src_data;                                                                        // spi_1_spi_control_port_agent:rdata_fifo_src_data -> avalon_st_adapter_014:in_0_data
	wire          spi_1_spi_control_port_agent_rdata_fifo_src_ready;                                                                       // avalon_st_adapter_014:in_0_ready -> spi_1_spi_control_port_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_014_out_0_valid;                                                                                       // avalon_st_adapter_014:out_0_valid -> spi_1_spi_control_port_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_014_out_0_data;                                                                                        // avalon_st_adapter_014:out_0_data -> spi_1_spi_control_port_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_014_out_0_ready;                                                                                       // spi_1_spi_control_port_agent:rdata_fifo_sink_ready -> avalon_st_adapter_014:out_0_ready
	wire    [0:0] avalon_st_adapter_014_out_0_error;                                                                                       // avalon_st_adapter_014:out_0_error -> spi_1_spi_control_port_agent:rdata_fifo_sink_error
