...
module top_level_mm_interconnect_0 (
	...
	wire    [8:0] rsp_mux_src_channel;                                                               // rsp_mux:src_channel -> top_level_data_master_agent:rp_channel
	...
	wire    [8:0] rsp_mux_001_src_channel;                                                           // rsp_mux_001:src_channel -> top_level_instruction_master_agent:rp_channel
	...
	wire    [8:0] cmd_mux_001_src_channel;                                                           // cmd_mux_001:src_channel -> alt_vip_cl_vfb_0_control_agent:cp_channel
	...
	wire    [8:0] cmd_mux_003_src_channel;                                                           // cmd_mux_003:src_channel -> top_level_debug_mem_slave_agent:cp_channel
	...
	wire  [117:0] cmd_mux_005_src_data;                                                              // cmd_mux_005:src_data -> ledr_s1_agent:cp_data
	...
	wire  [117:0] cmd_mux_006_src_data;                                                              // cmd_mux_006:src_data -> sw_s1_agent:cp_data
	...
	wire  [117:0] cmd_mux_007_src_data;                                                              // cmd_mux_007:src_data -> timer_0_s1_agent:cp_data
	...
	wire  [117:0] ledr_s1_agent_rp_data;                                                             // ledr_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [117:0] sw_s1_agent_rp_data;                                                               // sw_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [117:0] timer_0_s1_agent_rp_data;                                                          // timer_0_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [117:0] onchip_memory2_0_s1_agent_rp_data;                                                 // onchip_memory2_0_s1_agent:rp_data -> router_011:sink_data
	...
	wire          cmd_mux_008_src_valid;                                                             // cmd_mux_008:src_valid -> onchip_memory2_0_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_008_src_data;                                                              // cmd_mux_008:src_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	wire          cmd_mux_008_src_ready;                                                             // onchip_memory2_0_s1_burst_adapter:sink0_ready -> cmd_mux_008:src_ready
	wire    [8:0] cmd_mux_008_src_channel;                                                           // cmd_mux_008:src_channel -> onchip_memory2_0_s1_burst_adapter:sink0_channel
	wire          cmd_mux_008_src_startofpacket;                                                     // cmd_mux_008:src_startofpacket -> onchip_memory2_0_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                       // cmd_mux_008:src_endofpacket -> onchip_memory2_0_s1_burst_adapter:sink0_endofpacket
	...
	wire  [117:0] cmd_demux_001_src2_data;                                                           // cmd_demux_001:src2_data -> cmd_mux_007:sink1_data
	...
	wire  [117:0] rsp_demux_007_src1_data;                                                           // rsp_demux_007:src1_data -> rsp_mux_001:sink2_data
	...
	wire  [117:0] rsp_mux_002_src_data;                                                              // rsp_mux_002:src_data -> alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter:in_data
	wire          rsp_mux_002_src_ready;                                                             // alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter:in_ready -> rsp_mux_002:src_ready
	wire    [8:0] rsp_mux_002_src_channel;                                                           // rsp_mux_002:src_channel -> alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter:in_channel
	...
	wire  [369:0] alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter_src_data;                         // alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter:out_data -> alt_vip_cl_vfb_0_mem_master_rd_agent:rp_data
	...
	wire    [8:0] alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter_src_channel;                      // alt_vip_cl_vfb_0_mem_master_rd_rsp_width_adapter:out_channel -> alt_vip_cl_vfb_0_mem_master_rd_agent:rp_channel
	...
	wire  [369:0] router_002_src_data;                                                               // router_002:src_data -> alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter:in_data
	wire          router_002_src_ready;                                                              // alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter:in_ready -> router_002:src_ready
	wire    [8:0] router_002_src_channel;                                                            // router_002:src_channel -> alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter:in_channel
	...
	wire  [117:0] alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter_src_data;                         // alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter:out_data -> cmd_demux_002:sink_data
	...
	wire    [8:0] alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter_src_channel;                      // alt_vip_cl_vfb_0_mem_master_rd_cmd_width_adapter:out_channel -> cmd_demux_002:sink_channel
	...
	wire  [117:0] cmd_demux_002_src0_data;                                                           // cmd_demux_002:src0_data -> crosser_002:in_data
	...
	wire  [117:0] crosser_002_out_data;                                                              // crosser_002:out_data -> cmd_mux_008:sink2_data
	wire          crosser_002_out_ready;                                                             // cmd_mux_008:sink2_ready -> crosser_002:out_ready
	wire    [8:0] crosser_002_out_channel;                                                           // crosser_002:out_channel -> cmd_mux_008:sink2_channel
	...
	wire  [117:0] rsp_demux_001_src1_data;                                                           // rsp_demux_001:src1_data -> crosser_004:in_data
	wire          rsp_demux_001_src1_ready;                                                          // crosser_004:in_ready -> rsp_demux_001:src1_ready
	wire    [8:0] rsp_demux_001_src1_channel;                                                        // rsp_demux_001:src1_channel -> crosser_004:in_channel
	...
	wire  [117:0] crosser_004_out_data;                                                              // crosser_004:out_data -> rsp_mux_001:sink0_data
	...
	wire          rsp_demux_008_src2_valid;                                                          // rsp_demux_008:src2_valid -> crosser_005:in_valid
	wire  [117:0] rsp_demux_008_src2_data;                                                           // rsp_demux_008:src2_data -> crosser_005:in_data
	wire          rsp_demux_008_src2_ready;                                                          // crosser_005:in_ready -> rsp_demux_008:src2_ready
	wire    [8:0] rsp_demux_008_src2_channel;                                                        // rsp_demux_008:src2_channel -> crosser_005:in_channel
	wire          rsp_demux_008_src2_startofpacket;                                                  // rsp_demux_008:src2_startofpacket -> crosser_005:in_startofpacket
	wire          rsp_demux_008_src2_endofpacket;                                                    // rsp_demux_008:src2_endofpacket -> crosser_005:in_endofpacket
	wire          crosser_005_out_valid;                                                             // crosser_005:out_valid -> rsp_mux_002:sink0_valid
	wire  [117:0] crosser_005_out_data;                                                              // crosser_005:out_data -> rsp_mux_002:sink0_data
	...
	wire          onchip_memory2_0_s1_agent_rdata_fifo_out_valid;                                    // onchip_memory2_0_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] onchip_memory2_0_s1_agent_rdata_fifo_out_data;                                     // onchip_memory2_0_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_008:in_0_data
	wire          onchip_memory2_0_s1_agent_rdata_fifo_out_ready;                                    // avalon_st_adapter_008:in_0_ready -> onchip_memory2_0_s1_agent_rdata_fifo:out_ready
	...
	top_level_mm_interconnect_0_router_004 router_010 (
	...
	top_level_mm_interconnect_0_router_011 router_011 (
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (top_level_reset_reset_bridge_in_reset_reset),             // cr0_reset.reset
	...
	top_level_mm_interconnect_0_cmd_mux_001 cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (top_level_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	top_level_mm_interconnect_0_cmd_mux_008 cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (top_level_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	top_level_mm_interconnect_0_rsp_demux_008 rsp_demux_008 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (top_level_reset_reset_bridge_in_reset_reset), // clk_reset.reset
