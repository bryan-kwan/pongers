...
module top_level_mm_interconnect_0 (
	...
	wire   [10:0] rsp_mux_001_src_channel;                                                                             // rsp_mux_001:src_channel -> top_level_data_master_agent:rp_channel
	...
	wire   [10:0] rsp_mux_002_src_channel;                                                                             // rsp_mux_002:src_channel -> top_level_instruction_master_agent:rp_channel
	...
	wire   [10:0] cmd_mux_001_src_channel;                                                                             // cmd_mux_001:src_channel -> video_pixel_buffer_dma_0_avalon_control_slave_agent:cp_channel
	...
	wire   [10:0] cmd_mux_002_src_channel;                                                                             // cmd_mux_002:src_channel -> top_level_debug_mem_slave_agent:cp_channel
	...
	wire   [10:0] cmd_mux_004_src_channel;                                                                             // cmd_mux_004:src_channel -> timer_0_s1_agent:cp_channel
	...
	wire   [10:0] cmd_mux_005_src_channel;                                                                             // cmd_mux_005:src_channel -> jtag_uart_0_avalon_jtag_slave_agent:cp_channel
	...
	wire          cmd_mux_008_src_valid;                                                                               // cmd_mux_008:src_valid -> altpll_1_pll_slave_agent:cp_valid
	wire  [109:0] cmd_mux_008_src_data;                                                                                // cmd_mux_008:src_data -> altpll_1_pll_slave_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                                               // altpll_1_pll_slave_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [10:0] cmd_mux_008_src_channel;                                                                             // cmd_mux_008:src_channel -> altpll_1_pll_slave_agent:cp_channel
	wire          cmd_mux_008_src_startofpacket;                                                                       // cmd_mux_008:src_startofpacket -> altpll_1_pll_slave_agent:cp_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                                         // cmd_mux_008:src_endofpacket -> altpll_1_pll_slave_agent:cp_endofpacket
	...
	wire  [109:0] cmd_mux_009_src_data;                                                                                // cmd_mux_009:src_data -> ledr_s1_agent:cp_data
	wire          cmd_mux_009_src_ready;                                                                               // ledr_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [10:0] cmd_mux_009_src_channel;                                                                             // cmd_mux_009:src_channel -> ledr_s1_agent:cp_channel
	...
	wire   [91:0] router_003_src_data;                                                                                 // router_003:src_data -> new_sdram_controller_0_s1_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                                                                // new_sdram_controller_0_s1_rsp_width_adapter:in_ready -> router_003:src_ready
	wire   [10:0] router_003_src_channel;                                                                              // router_003:src_channel -> new_sdram_controller_0_s1_rsp_width_adapter:in_channel
	...
	wire   [10:0] new_sdram_controller_0_s1_rsp_width_adapter_src_channel;                                             // new_sdram_controller_0_s1_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire   [10:0] cmd_mux_src_channel;                                                                                 // cmd_mux:src_channel -> new_sdram_controller_0_s1_cmd_width_adapter:in_channel
	...
	wire   [10:0] cmd_demux_001_src1_channel;                                                                          // cmd_demux_001:src1_channel -> crosser_002:in_channel
	...
	wire   [10:0] crosser_002_out_channel;                                                                             // crosser_002:out_channel -> cmd_mux_001:sink0_channel
	...
	wire   [10:0] cmd_demux_002_src0_channel;                                                                          // cmd_demux_002:src0_channel -> crosser_003:in_channel
	...
	wire   [10:0] cmd_demux_002_src1_channel;                                                                          // cmd_demux_002:src1_channel -> crosser_004:in_channel
	...
	wire  [109:0] rsp_demux_src0_data;                                                                                 // rsp_demux:src0_data -> crosser_005:in_data
	...
	wire  [109:0] crosser_005_out_data;                                                                                // crosser_005:out_data -> rsp_mux:sink0_data
	...
	wire  [109:0] rsp_demux_src1_data;                                                                                 // rsp_demux:src1_data -> crosser_006:in_data
	wire          rsp_demux_src1_ready;                                                                                // crosser_006:in_ready -> rsp_demux:src1_ready
	wire   [10:0] rsp_demux_src1_channel;                                                                              // rsp_demux:src1_channel -> crosser_006:in_channel
	...
	wire  [109:0] crosser_006_out_data;                                                                                // crosser_006:out_data -> rsp_mux_001:sink0_data
	wire          crosser_006_out_ready;                                                                               // rsp_mux_001:sink0_ready -> crosser_006:out_ready
	wire   [10:0] crosser_006_out_channel;                                                                             // crosser_006:out_channel -> rsp_mux_001:sink0_channel
	...
	wire  [109:0] rsp_demux_src2_data;                                                                                 // rsp_demux:src2_data -> crosser_007:in_data
	wire          rsp_demux_src2_ready;                                                                                // crosser_007:in_ready -> rsp_demux:src2_ready
	wire   [10:0] rsp_demux_src2_channel;                                                                              // rsp_demux:src2_channel -> crosser_007:in_channel
	...
	wire   [10:0] crosser_007_out_channel;                                                                             // crosser_007:out_channel -> rsp_mux_002:sink0_channel
	...
	wire   [10:0] crosser_008_out_channel;                                                                             // crosser_008:out_channel -> rsp_mux_001:sink1_channel
	...
	wire  [109:0] rsp_demux_001_src1_data;                                                                             // rsp_demux_001:src1_data -> crosser_009:in_data
	wire          rsp_demux_001_src1_ready;                                                                            // crosser_009:in_ready -> rsp_demux_001:src1_ready
	wire   [10:0] rsp_demux_001_src1_channel;                                                                          // rsp_demux_001:src1_channel -> crosser_009:in_channel
	...
	wire   [10:0] crosser_009_out_channel;                                                                             // crosser_009:out_channel -> rsp_mux_002:sink1_channel
	...
	wire          top_level_debug_mem_slave_agent_rdata_fifo_out_valid;                                                // top_level_debug_mem_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] top_level_debug_mem_slave_agent_rdata_fifo_out_data;                                                 // top_level_debug_mem_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          top_level_debug_mem_slave_agent_rdata_fifo_out_ready;                                                // avalon_st_adapter_002:in_0_ready -> top_level_debug_mem_slave_agent_rdata_fifo:out_ready
	...
	wire          altpll_1_pll_slave_agent_rdata_fifo_out_valid;                                                       // altpll_1_pll_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] altpll_1_pll_slave_agent_rdata_fifo_out_data;                                                        // altpll_1_pll_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_008:in_0_data
	wire          altpll_1_pll_slave_agent_rdata_fifo_out_ready;                                                       // avalon_st_adapter_008:in_0_ready -> altpll_1_pll_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_008_out_0_valid;                                                                   // avalon_st_adapter_008:out_0_valid -> altpll_1_pll_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_008_out_0_data;                                                                    // avalon_st_adapter_008:out_0_data -> altpll_1_pll_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_008_out_0_ready;                                                                   // altpll_1_pll_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire    [0:0] avalon_st_adapter_008_out_0_error;                                                                   // avalon_st_adapter_008:out_0_error -> altpll_1_pll_slave_agent:rdata_fifo_sink_error
	wire          ledr_s1_agent_rdata_fifo_out_valid;                                                                  // ledr_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_009:in_0_valid
	wire   [33:0] ledr_s1_agent_rdata_fifo_out_data;                                                                   // ledr_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_009:in_0_data
	wire          ledr_s1_agent_rdata_fifo_out_ready;                                                                  // avalon_st_adapter_009:in_0_ready -> ledr_s1_agent_rdata_fifo:out_ready
	...
	top_level_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                              //       clk.clk
		.reset              (altpll_0_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	top_level_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                              //       clk.clk
		.reset              (altpll_0_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	top_level_mm_interconnect_0_rsp_demux_002 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                              //       clk.clk
		.reset              (altpll_0_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
