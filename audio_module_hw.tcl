...
# Fri Feb 24 16:22:54 MST 2023
# DO NOT MODIFY


# 
# audio_module "audio_module" v1.4
#  2023.02.24.16:22:54
# Going back to reading but 0 for the writedata bus because the screen got messed up in 1.3
# 
...
# module audio_module
# 
set_module_property DESCRIPTION "Going back to reading but 0 for the writedata bus because the screen got messed up in 1.3"
...
add_fileset_file audio_avalon_interface.v VERILOG PATH audio_avalon_interface.v TOP_LEVEL_FILE
